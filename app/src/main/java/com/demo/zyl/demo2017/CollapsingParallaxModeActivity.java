...
public class CollapsingParallaxModeActivity extends AppCompatActivity {

    private static final String TAG = "CollapsingParallaxModeActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_collapsing_parallax_mode);
        init();
    }
    ...
    private void setScrollFlag2Scroll() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.collapse_mode_parallax_scroll_flag_scroll, contentContainer, false);
    ...
    private void setScrollFlag2ScrollEnterAlways() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.collapse_mode_parallax_scroll_flag_scroll_enteralways, contentContainer, false);
        contentContainer.addView(view);
        setToolbar();
    }
    ...
    private void setScrollFlag2ScrollExitUntilCollapsed() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.collapse_mode_parallax_scroll_flag_scroll_exituntilcollapsed, contentContainer, false);
        contentContainer.addView(view);
        setToolbar();
    }
    ...
    private void setScrollFlag2ScrollEnterAlwaysExitUtilCollapsed() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.collapse_mode_parallax_scroll_flag_scroll_enteralways_exituntilcollapsed, contentContainer, false);
        contentContainer.addView(view);
        setToolbar();
    }
    ...
    private void setScrollFlag2ScrollSnap() {
        ...
        View view = LayoutInflater.from(this).inflate(R.layout.collapse_mode_parallax_scroll_flag_scroll_snap, contentContainer, false);
        contentContainer.addView(view);
        setToolbar();
    }
